...
var MessageOverlayWithContext = function MessageOverlayWithContext(props) {
  ...
  var _ref = wrapMessageInTheme ? modifiedTheme : theme,
    ...
    light_gray = _ref$colors.light_gray,
    transparent = _ref$colors.transparent,
    white_snow = _ref$colors.white_snow,
    ...
    receiverMessageBackgroundColor = _ref$messageSimple$co.receiverMessageBackgroundColor,
    replyContainer = _ref$messageSimple$co.replyContainer,
    senderMessageBackgroundColor = _ref$messageSimple$co.senderMessageBackgroundColor,
          ...
          children: [handleReaction && ownCapabilities != null && ownCapabilities.sendReaction ? (0, _jsxRuntime.jsx)(OverlayReactionList, {
            ...
            children: [alignment === 'left' && MessageAvatar && (0, _jsxRuntime.jsx)(MessageAvatar, {
              ...
              style: [styles.containerInner, {
                backgroundColor: onlyEmojis && !message.quoted_message ? transparent : otherAttachments != null && otherAttachments.length ? otherAttachments[0].type === 'giphy' ? !message.quoted_message ? transparent : grey_gainsboro : blue_alice : alignment === 'left' ? receiverMessageBackgroundColor != null ? receiverMessageBackgroundColor : white_snow : senderMessageBackgroundColor != null ? senderMessageBackgroundColor : light_gray,
                  ...
                  case 'poll':
                    {
                      ...
                      return Poll && pollId && ownCapabilities ? (0, _jsxRuntime.jsx)(_contexts.OwnCapabilitiesProvider, {
                        value: ownCapabilities,
                        children: (0, _jsxRuntime.jsx)(Poll, {})
                      }, "poll_".concat(pollId)) : null;
                    }
                  case 'text':
                  default:
