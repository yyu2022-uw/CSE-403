...
var MessageWithContext = function MessageWithContext(props) {
  ...
  var PollWrapper = (0, _react.useCallback)(function () {
    var poll = message != null && message.poll_id ? client.polls.fromState(message.poll_id) : undefined;
    return message != null && message.poll_id && poll ? (0, _jsxRuntime.jsx)(_Poll.Poll, {
      message: message,
      poll: poll,
